...
Version 1.10.1 draws every player character above every nameplate in replay previews and MP4 exports, so a character crossing another player's name remains visible instead of being covered by the text.
